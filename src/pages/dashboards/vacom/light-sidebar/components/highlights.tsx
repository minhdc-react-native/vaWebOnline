...
type IVcHighlightsRows = Array<IVcHighlightsRow>;

interface IVcHighlightsItem {
  badgeColor: string;
  label: string;
}
type IVcHighlightsItems = Array<IVcHighlightsItem>;

interface IVcHighlightsProps {
  limit?: number;
}

const VcHighlights = ({ limit }: IVcHighlightsProps) => {
  const rows: IVcHighlightsRows = [
    {
      icon: RiStore2Line,
      text: 'Online Store',
      total: 172,
  ...
  const renderItem = (item: IVcHighlightsItem, index: number) => {
    return (
...
export {
  VcHighlights,
  type IVcHighlightsRow,
  type IVcHighlightsRows,
  type IVcHighlightsItem,
  type IVcHighlightsItems,
  type IVcHighlightsProps,
};
