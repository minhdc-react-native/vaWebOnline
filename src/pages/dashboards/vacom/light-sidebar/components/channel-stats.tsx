...
type IVcChannelStatsItems = Array<IVcChannelStatsItem>;

const VcChannelStats = () => {
  const items: IVcChannelStatsItems = [
  ...
  const renderItem = (item: IVcChannelStatsItem, index: number) => {
    return (
      <Card key={index}>
...
export { VcChannelStats, type IVcChannelStatsItem, type IVcChannelStatsItems };
